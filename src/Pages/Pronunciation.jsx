        ...
        <div className="modal modal-bottom modal-middle">
          ...
          <div className="modal-box text-[15px]">          
            ...
            <div className='text-[12px] sm:text-[14px]'>
              ...
              <div className="py-1 leading-relaxed">Esta aplicação web foi desenvolvida para computadores de mesa (desktop), mas funciona também em dispositivos móveis com sistema operacional Android. Por favor, dê preferência em acessá-lo pelo navegador Google Chrome. Em dispositivos móveis com sistema IOS (Apple), o usuário vai poder visualizar as palavras e suas traduções, mas não conseguirá ouvir a pronúncia ou tentar pronunciar;</div>
          ...
          <div  className='text-[12px] sm:text-[14px]'>
            ...
            <div className="py-1 leading-relaxed">This web application was developed for desktop computers (desktop), but it also works on mobile devices with Android operating system. Please, prefer to access it through the Google Chrome browser. On mobile devices with an IOS system (Apple), the user will be able to view the words and their translations, but will not be able to hear the pronunciation or try to pronounce them;</div>
